...
class ConViT_ADDG(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 meth=None, teachers=None, args=None):
    ...
    def forward_features(self, x):
        ...
        for u, blk in enumerate(self.blocks):
            ...
            if self.meth == 'ADDG' and u in self.mixstyle_layers:
        ...
        return [x_adr[..., 0], x[:,0]], [branch_out, b2_out[..., 0]], block_feats
...
def _create_convit(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(
        ConViT_ADDG, variant, pretrained,
        default_cfg=default_cfgs[variant],
        **kwargs)


@register_model
def convit_base_ADDG(pretrained=True, **kwargs):
    model_args = dict(
