...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.3,
...
def _create_vision_transformer(variant, pretrained=True, default_cfg=None, **kwargs):
    ...
    model = build_model_with_cfg(
        ...
        pretrained_custom_load='npz' in default_cfg['url'], pretrained_strict=False, **kwargs)
    return model
